...
import com.zym.memorymaster.presenters.RegPresenter;
        ...
        if (v.isClickable()) {
            ...
            switch (v.getId()) {
                ...
                case R.id.reg_get_check_code:
                    mRegPresenter.getCheckCode(mPhoneNumberEdit.getText().toString());
...
//                mShowMessage("do reg");
                    ...
                    mRegPresenter.registe(keys, values);
                    break;
            }
        }
    ...
    @Override
    public void onRegSuccess(BaseModel result) {
        finish();
    }

    @Override
    public void onRegFailure(String msg) {
        onActionFailed(msg);
    }
